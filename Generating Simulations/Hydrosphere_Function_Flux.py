...
def hydrosphere_flux(surface_p, max_surface_t, min_surface_t, res_t, min_water_mass, max_water_mass, res_mw, core_radius, res_radius, core_density, rawdata_flg):
...
# Calculate data for T=260-350 K and MW=1-20% total mass
hydrosphere_flux(surface_p=0.1, min_surface_t=260, max_surface_t=350, res_t=20, min_water_mass=0.01*5.972e+24, max_water_mass=0.20*5.972e+24, res_mw=20, core_radius=0.6*6.36e+06, res_radius=1, core_density=5500,rawdata_flg=1)
